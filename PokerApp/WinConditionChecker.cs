...
namespace PokerApp
{
    internal class WinConditionChecker
    {
        ...
        private bool IsStrictDraw { get; }

        internal WinConditionChecker(IReadOnlyList<IPlayer> players, bool filterWinnersOnDrawsByHighCardValue)
        {
            IsStrictDraw = filterWinnersOnDrawsByHighCardValue;
            Players = players;
